  ...
  return (
    <div className="bg-[#121212] pt-[4rem] md:pt-[8rem] pb-[5rem]">
      ...
      <div data-aos="fade-right">
        ...
        <p className="text-[15px] text-white font-normal">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Aspernatur, enim a assumenda, quam cum laudantium nobis est fuga doloribus, odit iste in ad. Atque autem sint mollitia ad iste dignissimos.</p>
        </div>
      </div>
