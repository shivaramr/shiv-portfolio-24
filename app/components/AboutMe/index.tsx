        ...
        <div>
          ...
          <div className="mb-[3rem] flex items-center md:space-x-10">
            ...
            <p className="text-[19px] text-slate-300 w-[80%]">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Excepturi, aspernatur eius
              ducimus libero mollitia enim ut quaerat quod velit maiores. Vero voluptatibus corrupti
              unde error ipsa necessitatibus dolore ab rerum.
            </p>
          </div>
