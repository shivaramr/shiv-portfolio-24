  ...
  return (
    <div className='h-[88vh] bg-[url("/images/banner.jpg")] mt-[8vh] bg-cover bg-center'>
      ...
      <div className="w-[80%] grid-cols-1 mx-auto grid lg:grid-cols-2 gap-[3rem] h-[100%] items-center">
        ...
        <div className="w-[500px] hidden bg-[#55e6a5] hover:bg-[#02050a] relative lg:flex items-center rounded-full h-[500px] transform transition-all duration-300 hover:scale-x-[-1]">
          <Image
